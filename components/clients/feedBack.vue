        ...
        v-form(ref="feedback_form")
          ...
          v-file-input(
            ...
            template(v-slot:selection="{ index, text }")
              ...
              span.overline.grey--text.text--darken-3.mx-2(
                v-else-if="index === 2"
              ) + {{ feedback.picture.length - 2 }} File(s)
      v-card-actions
        v-progress-circular(
          v-if="isLoading",
          :width="1",
        ...
        v-spacer
        v-btn.mr-4(outlined, color="brown darken-1", @click="formSubmit") submit
        v-btn(
          outlined,
          color="brown darken-1",
          @click="comment_dialog = false"
