        ...
        v-col(cols="10")
          div.text-center
            v-avatar(
              size="90"
              tile)
              img(src="https://www.khland.com.kh/assets/images/kh_lg.png")
          .text-center.mt-5
            v-btn(small outlined @click="print_page()" color="primary") Print this page
    ...
    v-container
      v-row
        v-col(cols="12")
          v-row
            v-col(cols="6")
              h1.text-left.text-h6
                strong វីឡាតូលកូនកាត់

            v-col(cols="6")
              h1.text-right.text-h6 តំលៃ: $ 100000

          img(
            height="500"
            src="https://scontent.fpnh1-2.fna.fbcdn.net/v/t1.0-9/118149058_1802696249896606_8024808295273225789_o.jpg?_nc_cat=101&_nc_sid=730e14&_nc_ohc=-Dkx1ZnqTboAX_Sg5iM&_nc_ht=scontent.fpnh1-2.fna&oh=edb2c70cf8a59fe8fcfc6b43af08e67c&oe=5F951D02")
      v-row
        v-col.mt-n3(cols="12" sm="12" md="6" lg="6" xl="6")
          v-row.row-details(no-gutters)
            v-col.pl-3(cols="6")
              .text-subtitle-2(justify="center")
                strong ពិពណ៌នា
            v-col(cols="2")
              .subtitle-2
                strong លេខកូដ
...
<script>
import configuredRow from '@/components/configuration/configuredRow'
export default {
  ...
  data () {
    return {
      ...
      item_details: [
        ...
        { title: 'Cindy Baker', avatar: 'https://picsum.photos/200/200' },
        { title: 'Ali Connors', avatar: 'https://picsum.photos/200/200' },
      ],
      items: [
        {
          src: 'https://scontent.fpnh1-2.fna.fbcdn.net/v/t1.0-9/117783770_1802414876591410_3603053929977972203_o.jpg?_nc_cat=111&_nc_sid=730e14&_nc_ohc=Ag5SXRCccTMAX_wqOWV&_nc_ht=scontent.fpnh1-2.fna&oh=c2c3e58e7726c392ee82d52fbff820cf&oe=5F85FF5F',
        },
        {
...
#configured_table table thead tr th {
  color: $color-primary;
}

#configured_table table tbody tr:hover {
  background: none;
}
